...
def test_multi_classification(dataloader, model, loss_fn, device="cpu") -> tuple:
    ...
    # prediction과 trule label 담을 리트트
    predictions = []
    true_labels = []
...
def train(dataloader, model, loss_fn, optimizer, device="cpu", mode:"binary or multi"='binary'):
    ...
    if mode == 'binary':
        ...
        train_loss, train_accuracy,predictions, true_labels  = test_multi_classification(dataloader, model, loss_fn, device)
...
def fit(train_loader, val_loader, model, loss_fn, optimizer, epochs, save_best_model=True, 
    ...
    for epoch in range(epochs):
        ...
        if mode == "binary":
            ...
            val_loss, val_accuracy,predictions, true_labels = test_multi_classification(val_loader, model, loss_fn, device=device)
